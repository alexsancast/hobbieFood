{
    ...
    'data': [
        ...
        'wizard/margin_report.xml',
        'report/report_styles_template.xml',
        'report/filter_bar_template.xml',
        'report/report.xml',
        'report/report_partner_ledger.xml',
        'report/report_general_ledger.xml',
        'report/report_trial_balance.xml',
        'report/report_financial.xml',
        'report/report_financial_view.xml',
        'report/report_trial_balance_view.xml',
        'report/report_general_ledger_view.xml',
        'report/report_partner_ledger_view.xml',
        'report/report_aged_partner_view.xml',
        'report/report_tax_view.xml',
        'report/report_journal_audit_view.xml',
        'report/report_margin_view.xml',
        'report/report_tax.xml',
        'report/report_aged_partner.xml',
        'report/report_journal_audit.xml',
        'report/report_margin.xml',
        'report/report_journal_entries.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'accounting_pdf_reports/static/src/report_iframe/report_iframe.js',
            'accounting_pdf_reports/static/src/report_iframe/report_iframe.xml',
        ],
    },
